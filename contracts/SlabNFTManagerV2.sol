    ...
    IERC721Receiver
{
    ...
    // ============ State Variables ============
    // IMPORTANT: Storage layout must remain compatible with v1.0.0
    ...
    function setOwnerWallet(address newOwner) external onlyOwner {
        ...
        emit OwnerWalletUpdated(oldOwner, newOwner);
    }
    ...
    /**
     * @notice Get the maximum inventory size
     * @return maxSize Maximum NFTs allowed in inventory
     */
    function getMaxInventorySize() external pure returns (uint8 maxSize) {
