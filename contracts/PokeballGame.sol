    ...
    PausableUpgradeable
{
    ...
    uint8 public constant MAX_ACTIVE_POKEMON = 3;
    ...
    Pokemon[MAX_ACTIVE_POKEMON] public activePokemons;
     ...
     * @param slotIndex Slot in activePokemons array
     */
     ...
     * @param pokemonSlot Index in activePokemons array (0-2)
     ...
     * @param slot Slot index (0-2) to spawn Pokemon
     */
     ...
     * @return pokemons Array of all Pokemon structs
     */
    function getAllActivePokemons() external view returns (Pokemon[3] memory pokemons) {
